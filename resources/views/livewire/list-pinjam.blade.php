            ...
            <template x-for="buku, i in data" :key="buku.id">
                <div class="bg-[#ffffff] rounded-lg">
                    ...
                    <div class="w-[250px]">
                        ...
                        <div>
                            <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#e55d5d] rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                <button>Klik untuk baca.!</button>
                            </a>
                        </div>
                    </div>
                </div>
